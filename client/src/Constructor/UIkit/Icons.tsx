...
export function DeleteIcon({ onclick }: any) {
    return (
        <div className="delete-icon" onClick={onclick}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 4L12 12" stroke="#777777" stroke-width="2" stroke-linecap="square" stroke-linejoin="round" />
                <path d="M4 12L12 4" stroke="#777777" stroke-width="2" stroke-linecap="square" stroke-linejoin="round" />
            </svg>
        </div>
    )
}
...
export function ImageIcon() {
    return (
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5 19H19V13M5 19H1V1H19V13M5 19L15 9L19 13" stroke="#D0D0D0" stroke-width="2" />
            <circle cx="7" cy="7" r="2" stroke="#D0D0D0" stroke-width="2" />
        </svg>
    )
}